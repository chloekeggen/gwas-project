...
def preprocess_gwas_data(phenotype_file, genotype_file, maf_threshold=0.05):
    ...
    genotype_data = filter_snps(genotype_data, maf_threshold)
...
def generate_manhattan_plot(results_df, output_prefix):
